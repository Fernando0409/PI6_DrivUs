...
<html lang="es">
  ...
  <body id="body-pd">
    ...
    <main>
      <div class="perfil">
        <a href="carList.php"><button type="button" class="btn btn-info" style="width:300px; height: 100px;">Lista de Automoviles</button> </a> <br>
        <a href="addCar.php"><button type="button" class="btn btn-info" style="width:300px; height: 100px; margin-top:10px;">Añadir automovil</button></a>
      </div>
    </main>
